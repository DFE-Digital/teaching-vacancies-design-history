...
- when entering their work history, jobseekers often didn’t notice the gaps flagged by the system. When asked to go back and explain these gaps, they struggled to find the right section to complete before continuing their application.
...
- introduced a radio response option when asking for a national insurance number to make the design clearer and show that it is optional
- updated the work history screen to have a summary card design to reduce the level of information on the page 
- introduced error messaging and alerts to make work history gaps more obvious.
...
- added validation to the references section to prevent jobseekers from continuing without a reference. KCSIE mandates a reference from their current or most recent employer.
