---
title: Job listing journey improvements 
date: 2025-07-30
tags:
  - hiring_staff
--- 
...
{{ appScreenshots({
  items: [
  {
    text: "The 'Job title' and 'What type of job is this' questions on the first section of the 'Create a job listing' user journey for hiring staff on the Teaching Vacancies website.",
    img: { src: "one.png" }
  },
  {
    text: "The 'Job start date' question in the Create a job listing user journey for hiring staff on the Teaching Vacancies website.",
    img: { src: "two.png" }
  },
  {
    text: "The 'Working pattern' question on the Create a job listing user journey for hiring staff on the Teaching Vacancies website.",
    img: { src: "three.png" }
  },
  {
    text: "The 'Contract type' question on the Create a job listing user journey for hiring staff on the Teaching Vacancies website.",
    img: { src: "four.png" }
  },
  {
